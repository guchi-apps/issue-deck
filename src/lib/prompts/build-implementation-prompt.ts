 ...
 *
 * **画面デザインはPC・iPad（横）・スマホ（iPhone 15）の3画面を並べて出す**（#1632・#2460）。PCの見た目
 * だけを承認してもスマホ幅での崩れは実装後の実画面まで分からず、「作る前に見た目を合意する」効きどころが
 * 半分になる。**iPadを足したのは、その幅がPC・スマホのどちらの1枚にも入らないため**（#2460）。
