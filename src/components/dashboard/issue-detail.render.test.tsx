 ...
 *
 * ここで使う`checkUserIssue()`は理由が`01.check-input`＝行き先が常に承認欄（コメント欄末尾）
 * になるケースで、#2924で行き先が計画・質問・対応PRのときだけ案内を出さなくした後も、
 * この理由では従来どおり出る（`issue-status-card.test.tsx`が出し分け自体のテストを持つ）。
 */
