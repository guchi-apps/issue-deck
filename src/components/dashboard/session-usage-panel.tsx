        ...
        <>
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            ...
            <Tile
              ...
              sub={`内訳 入力 ${formatUsageTokens(data.totals.inputTokens)}・書込 ${formatUsageTokens(data.totals.cacheCreateTokens)}・読出 ${formatUsageTokens(data.totals.cacheReadTokens)}`}
            />
            <Tile
              label="セッション"
