 ...
 * 「ほぼ全自動」を謳うが、GitHub Appのインストール対象への追加のように画面でしか
 * できないものが残ることがある。どこまでが自動かを実行前に読み取れるようにしておく。
 * **通常は「あなたが実行」が1件も出ない**（#2246。DNSは`*.gucchii.com`のワイルドカード、
 * VPS実機の受け入れは`guchi-apps/vps`のワークフローへ寄せた）。
 */
