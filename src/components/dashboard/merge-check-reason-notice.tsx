 ...
 *
 * 置き場所は「マージ待ち」の対応PRセクション（PCのIssue詳細・スマホのIssue詳細）の2か所で、
 * **同じ内容を同じ体裁で出す**。読む場所によって理由が違って見えないようにする。
 * **#2914でコメント欄のマージ待ちカードからは外した**——マージボタンごと対応PRセクションへ
 * 寄せたので、押す前に読める位置がそちらになった（コメント欄に残るのは「対応PRへ移動」だけ）。
