          ...
          <li key={i} className="flex flex-col gap-1">
            ...
            {step.action && (
              <a
                ...
                className={cn(
                  "ml-6 inline-flex items-center gap-1 rounded-md border border-amber-500/50 bg-amber-50 px-2 py-1 font-medium text-amber-700 hover:bg-amber-100 dark:bg-amber-950/40 dark:text-amber-300 dark:hover:bg-amber-950/70",
                  text,
                )}
              >
