 ...
 *
 * **呼ぶのは2か所だけ。** マージ待ちの承認カードを出すとき（`usePullRequestReview`）と、
 * PR詳細の「修正Issueを起案」を押したとき（`PullRequestFixIssueBar`・#2961。帯の強さはPR本文の
 * 判定だけで決まるため、表示時には取らない）。1回で2リクエスト（PR本体＋会話コメント）
