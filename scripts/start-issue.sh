...
build_env_prefix() {
  ...
  for var in ISSUE_DECK_WORKTREE_BASE ISSUE_DECK_SHARED_CONTEXT_DIR ISSUE_DECK_SKIP_LAN_SETUP \
    ...
    ISSUE_DECK_CLAUDE_RESUME ISSUE_DECK_AGENT ISSUE_DECK_CLAUDE_MODEL ISSUE_DECK_CLAUDE_SUBAGENT_MODEL \
    ISSUE_DECK_CODEX_MODEL ISSUE_DECK_CODEX_SANDBOX ISSUE_DECK_CODEX_EXTRA_ARGS; do
    value="${!var:-}"
    [[ -n "$value" ]] || continue
